...
public class VelocityConfigLoader {
  ...
  private VelocityConfigLoader(File file) {
    this.file = file;
    this.resourceFileName = file.getName();
  }

  private VelocityConfigLoader(File file, String resourceFileName) {
    this.file = file;
  ...
  public static VelocityConfigLoader load(File file, String resourceFileName) {
    return new VelocityConfigLoader(file, resourceFileName).load();
  }
